...
import com.me.scrollandgridview.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.saveButton.setOnClickListener {
            ...
            val users = UserData(name,location,phone)
            database.child(phone).setValue(users).addOnSuccessListener {
                ...
                val intent = Intent(this@UploadActivity, ContactActivity::class.java)
